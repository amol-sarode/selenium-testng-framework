...
public class LoginTest extends BaseTest {
	...
	public void verifyValidLogin() {
		...
		ExtentTest loginNode = ExtentReportManager.getTest().createNode("Verify Valid Login Test Steps");
		String username = "standard_user";
		String password = "secret_sauce";
		loginNode.info("Launch SauceDemo application");
		loginNode.info("Enter username : " + username);
		loginNode.info("Enter password : " + password);
		...
		Assert.assertEquals(homePage.getHomePageTitle(), "Products", "Incorrect page title after login");
		loginNode.pass("Products page title verified");
		loginNode.info("Verify menu button displayed");
		Assert.assertTrue(homePage.isMenuDisplayed(), "Menu button is not displayed");
	...
	@Test(description = "Verify login with locked user", groups = { "regression" })
	public void verifyLockedUserLogin() {

		log.info("TEST STARTED : Verify Locked User Login");
		ExtentTest loginNode = ExtentReportManager.getTest().createNode("Locked User Login Test Steps");
	...
	public void verifyInvalidLogin() {
		...
		ExtentTest loginNode = ExtentReportManager.getTest().createNode("Invalid Login Test Steps");
		LoginPage loginPage = PageObjectManager.getLoginPage();

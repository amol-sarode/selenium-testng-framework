...
public class EndToEndTest extends BaseTest {
    ...
    private static final Logger log =
            LoggerUtils.getLogger(EndToEndTest.class);



    @Test(
            description = "Verify complete purchase flow with valid user",
    ...
    public void verifyEndToEndPurchaseFlow() {
        ...
        Assert.assertEquals(
                completePage.getCompletePageTitle(),
                "Checkout: Complete!",
        ...
        Assert.assertEquals(
                completePage.getThankYouMessage(),
        ...
        ProductPage productPageAfterOrder =
                completePage.clickBackHome();



        Assert.assertEquals(
                productPageAfterOrder.getProductsPageTitle(),
                "Products",
